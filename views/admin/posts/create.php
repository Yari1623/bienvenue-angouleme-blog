...
function addSection(type) {
    ...
    const inputStyle = "width:100%;border-radius:.5rem;padding:.6rem .75rem;font-size:.875rem;font-family:'Source Sans 3',sans-serif;background:var(--bg);border:1.5px solid var(--border);color:var(--text);outline:none;";
