        ...
        <div class="surface rounded-xl p-6">
            ...
            <div id="sections-container" class="space-y-4 mb-4">
                ...
                <div class="section-block rounded-xl p-4 relative" data-index="<?= $i ?>"
                    ...
                    <?php
                    $is = "width:100%;border-radius:.5rem;padding:.6rem .75rem;font-size:.875rem;font-family:'Source Sans 3',sans-serif;background:var(--bg);border:1.5px solid var(--border);color:var(--text);outline:none;";
                    $t = $section['type'];
                    ?>
                    <?php if ($t==='text'): ?>
...
function addSection(type) {
    ...
    const is        = "width:100%;border-radius:.5rem;padding:.6rem .75rem;font-size:.875rem;font-family:'Source Sans 3',sans-serif;background:var(--bg);border:1.5px solid var(--border);color:var(--text);outline:none;";
