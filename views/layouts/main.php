...
<header class="navbar shadow-sm">
    ...
    <div style="border-bottom:1px solid var(--border)">
        ...
        <div class="max-w-7xl mx-auto px-4 pb-1.5" style="overflow:hidden;">
            <div class="flex items-center gap-2 text-xs py-1" style="font-family:'Source Sans 3',sans-serif;color:var(--muted);overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch;padding-bottom:2px;">
