...
<section class="relative rounded-2xl overflow-hidden" style="min-height:420px;">
    ...
    <div class="relative z-10 flex flex-col justify-center h-full px-8 md:px-16 py-16" style="min-height:420px;">
        <div class="max-w-2xl">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="<?= BASE_URL ?>/blog" class="btn-primary px-6 py-3">
                    Lire le blog →
                </a>
    ...
    <div class="absolute bottom-4 right-6 hidden md:flex gap-4">
        <?php
        $stats = [
            ['val'=> count($latestPosts ?? []) > 0 ? ($totalPosts ?? '0') : '0', 'label'=>'Articles'],
...
<section class="surface rounded-2xl overflow-hidden">
    <div class="grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="p-8 md:p-10 flex flex-col justify-center">
            <span class="text-xs font-bold uppercase tracking-widest mb-2" style="color:#1d8fd8;font-family:'Source Sans 3',sans-serif;">
                Histoire & Patrimoine
            </span>
            ...
            <p class="text-sm leading-relaxed mb-6" style="color:var(--text2);font-family:'Source Sans 3',sans-serif;">
                ...
                Ses remparts offrent un panorama exceptionnel sur la vallée verdoyante...
            </p>
            <a href="<?= BASE_URL ?>/histoire-angouleme" class="btn-outline self-start">
                En savoir plus →
            </a>
        </div>
    </div>
